...
This guide explains how to download **Copernicus DEM** data from the [Copernicus Data Space Browser](https://browser.dataspace.copernicus.eu/). Copernicus DEM is essential for geolocation and orthorectification in projects like Sen2VM.
...
Go to the **Search** tab and select **Copernicus DEM**.
...
Select the **Copernicus DEM Mosaic** workflow and click **Order Processing**.
