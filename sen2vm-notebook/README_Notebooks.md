...
* **notebook-direct-grid-otb.ipynb**
  Runs Sen2vm with the **direct** mode, using the downloaded inputs, along with the IERS file and L1B product, to product orthorectified and mosaicked imaged using otb functions.
